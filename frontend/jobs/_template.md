...
# Optional
expires_at: 2026-10-11                     # defaults to posted_at + 60 days
salary_min: 180000
salary_max: 260000
...
Two or three sentences of plain description. Say what the person owns and what the
robot has to do. Do not paste the employer's boilerplate.

## What you would work on

- Concrete responsibility, not a competency
- Another one
- A third

## What they are asking for

- Requirement stated as experience, not as years
- Another one

## Why this one is worth a look

One honest paragraph of editorial context on the company, the segment, or the stage of
the product. This is the part that makes the board worth reading instead of an
aggregator. Say something real, including the caveat if there is one.
