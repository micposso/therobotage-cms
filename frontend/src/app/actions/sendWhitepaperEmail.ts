...
export async function sendWhitepaperEmail(
  ...
  try {
    await resend.emails.send({
      from: FROM_ADDRESS,
      to: email,
      subject: 'Robot Experience Framework — your copy',
      html: `
        <div style="font-family: Georgia, serif; max-width: 560px; margin: 0 auto; color: #0D0D0D;">
          ...
          <p style="font-size: 15px; line-height: 1.75; color: #2A2A28; margin-bottom: 32px;">
            Here is your copy of the REF white paper. The framework is published under CC BY-NC 4.0 — you are free to use, adapt, and apply it to real deployments with attribution.
          </p>
          ...
          <p style="font-size: 12px; color: #2A2A28; opacity: 0.6; margin-top: 32px; line-height: 1.65;">
            therobotage.com/research/ref — CC BY-NC 4.0
          </p>
        </div>
      `,
    })
