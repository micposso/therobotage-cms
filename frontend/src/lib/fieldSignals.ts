...
export const fieldSignals: FieldSignal[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Deployers moving a robot between environments — even similar ones — should treat the transition as a new deployment, not a relocation. That means re-running the REF Interaction Fit assessment for the receiving context, re-calibrating behavioral parameters, and running a structured observation period before declaring operational readiness. The machine moved. Its behavioral model did not move with it automatically.',
    ],
  },
]
