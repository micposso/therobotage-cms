...
export const articles: Article[] = [
  ...
  },
  {
    ...
    body: [
      'Module 1.1 — Foundations of Robot Literacy — is now live and available to all registered learners. It is the first module of the Robotics Experience Practitioner (REP) certification, and it is free to complete.',
  ...
  },
  {
    ...
    body: [
      ...
      'The facility is now piloting a peer-mentorship model in which certified practitioners onboard new staff into the mixed environment. It is an early example of what institutional robot literacy looks like in practice — and it did not require a single engineer.',
    ],
  },
  {
    id: 6,
