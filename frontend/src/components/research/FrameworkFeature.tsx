      ...
      <div className="container-fluid">
        <div className={styles.layout}>
          ...
          <div>
            ...
            >{t("RXD — Robot Experience Design")}</motion.p>
            ...
            >
              ...
              >{t("Download white paper v2.0")}</button>
            </motion.div>
            ...
            >{t("Cite as: Posso, M. (2026).")}<em>{t("Robot Experience Design (RXD): A framework for evaluating the human side of consumer robotics")}</em>{t("(White Paper v2.0). The Robot Age. therobotage.com/rxd. CC BY-NC 4.0.")}</motion.p>
          </div>
          ...
          <motion.div
            ...
            aria-hidden="true"
          >
            <p className={styles.schematicLabel}>{t("RXD Dimensional Schema")}</p>
