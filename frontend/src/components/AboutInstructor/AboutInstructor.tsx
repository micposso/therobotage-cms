        ...
        <div className={styles.inner}>
          ...
          >
            <div className={styles.imageWrap}>
              <Image src="/brand/instructor.png" alt={t("Michael Posso")} fill sizes="(max-width: 424px) calc(100vw - 64px), 360px" className={styles.image} />
            </div>
          </motion.div>
