...
import { LanguageProvider } from '@/components/LanguageSwitcher/LanguageProvider';
import { getAvailableTranslations } from '@/lib/i18n/content';
...
export default function SiteDocument({
  ...
  return (
    <html lang={locale} className={`${fairview.variable} ${fairviewSmallCaps.variable} ${ibmPlexSans.variable} ${dmSerifDisplay.variable} ${outfit.variable}`}>
      <head>
      ...
      <body>
        ...
        <LanguageProvider locale={locale} available={getAvailableTranslations()}>
