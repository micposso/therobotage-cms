...
function saveConsent(analytics: boolean, marketing: boolean): ConsentPrefs {
  ...
  try { localStorage.setItem(CONSENT_KEY, JSON.stringify(prefs)) } catch { /* Consent remains usable when storage is blocked. */ }
                ...
                <div className={styles.prefInner}>
                  ...
                  <div className={styles.prefRow}>
                    <div className={styles.prefInfo}>
                      <span className={styles.prefLabel}>{t('Necessary')}</span>
                      <span className={styles.prefDesc}>{t('Session management and security. Always active.')}</span>
                    </div>
                  ...
                  <div className={styles.prefRow}>
                    <div className={styles.prefInfo}>
                      <span className={styles.prefLabel}>{t('Analytics')}</span>
                      <span className={styles.prefDesc}>{t('Helps us understand which pages are most useful. No personal data is sold.')}</span>
                    </div>
                    <button
                  ...
                  <div className={styles.prefRow}>
                    <div className={styles.prefInfo}>
                      <span className={styles.prefLabel}>{t('Marketing')}</span>
                      <span className={styles.prefDesc}>{t('Used to measure the effectiveness of outreach and promotions.')}</span>
                    </div>
                    <button
                      ...
                      aria-label={t('Toggle marketing cookies')}
                    >
                      <span className={styles.toggleThumb} />
                    </button>
                  </div>
