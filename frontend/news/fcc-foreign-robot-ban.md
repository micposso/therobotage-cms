---
slug: fcc-foreign-robot-ban
title: "The robot ban is a deployment test."
category: NEWS
date: July 31, 2026
excerpt: The FCC's new restrictions on foreign-made robots turn national-security policy into a practical deployment-readiness problem.
headerImage: /images/news/fcc-foreign-robot-ban-header.png
thumbnailImage: /images/news/fcc-foreign-robot-ban-thumb.png
...
The [Federal Communications Commission's national-security determination](https://www.fcc.gov/sites/default/files/robots-nsd.pdf) adds foreign-produced advanced robotic devices to the same policy universe as restricted telecom gear, surveillance equipment, drones, and other connected systems. [TechCrunch reported](https://techcrunch.com/2026/07/29/us-government-bans-new-foreign-made-humanoids-robot-dogs-and-solar-inverters-citing-risks-to-national-security/) that the move blocks new foreign-made humanoid robots, robot dogs, and power inverters from import authorization, with exceptions possible when the government finds a device does not present a national-security risk.
...
The ban arrived during the same week that robotics software took a visible step forward. Google DeepMind announced [Gemini Robotics 2](https://deepmind.google/blog/gemini-robotics-2-brings-whole-body-intelligence-to-robots/), describing whole-body control, dexterity, and teamwork across complex tasks. Google also introduced [Gemini Robotics ER 2](https://blog.google/innovation-and-ai/models-and-research/google-deepmind/gemini-robotics-er-2/), a higher-level embodied reasoning model with video understanding, tool orchestration, progress tracking, and multi-robot collaboration.
